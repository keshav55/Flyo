...
@interface MenuHome : UIViewController <MenuProtocol, ARDroneProtocolOut, UIAlertViewDelegate, /*ARStatusBarDelegate*/ UINavigationControllerDelegate, UIImagePickerControllerDelegate>
{
